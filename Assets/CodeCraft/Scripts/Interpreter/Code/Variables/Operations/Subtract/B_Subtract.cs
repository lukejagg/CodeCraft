...
{
    public class B_Subtract : MonoBehaviour, ICompilerValue
    {
        ...
        {
            return new Subtract(values[0]?.ConvertToValue(), values[1]?.ConvertToValue());
        }
        ...
        public void UpdateSize(int depth)
        {
            ...
            val2.anchoredPosition = new Vector2(w1 + 51, 0);
