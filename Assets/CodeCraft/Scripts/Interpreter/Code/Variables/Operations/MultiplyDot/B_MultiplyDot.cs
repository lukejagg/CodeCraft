...
{
    public class B_MultiplyDot : MonoBehaviour, ICompilerValue
    {
        public CodeType CodeType => CodeType.Value;

        public string SaveId => "dot";
        public string Save()
        {
            return SaveId;
        }
        ...
        {
            return new MultiplyDot(values[0]?.ConvertToValue(), values[1]?.ConvertToValue());
        }
        ...
        public void UpdateSize(int depth)
        {
            ...
            val2.anchoredPosition = new Vector2(w1 + 50, 0);
