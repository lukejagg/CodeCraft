...
{
    public class B_Mod : MonoBehaviour, ICompilerValue
    {
        ...
        {
            return new Remainder(values[0]?.ConvertToValue(), values[1]?.ConvertToValue());
        }
        ...
        public void UpdateSize(int depth)
        {
            ...
            text.anchoredPosition = new Vector2(w1 + 33, 0);
            val2.anchoredPosition = new Vector2(w1 + 61, 0);
