...
{
    public class B_ColorOf : MonoBehaviour, ICompilerValue
    {
        public CodeType CodeType => CodeType.Value;

        public string SaveId => "col";
        public string Save()
        {
            return SaveId;
        }
        ...
        {
            return new ColorOf(values[0]?.ConvertToValue());
        }
        ...
        public void UpdateSize(int depth)
        {
            ...
            blockImage.color = CodeUtil.ChangeValueColor(Colors.ColorColor, depth);
        }
