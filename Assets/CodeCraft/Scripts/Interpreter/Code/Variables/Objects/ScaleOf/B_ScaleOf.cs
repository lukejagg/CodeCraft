...
{
    public class B_ScaleOf : MonoBehaviour, ICompilerValue
    {
        public CodeType CodeType => CodeType.Value;

        public string SaveId => "scl";
        public string Save()
        {
            return SaveId;
        }
        ...
        {
            return new ScaleOf(values[0]?.ConvertToValue());
        }
        ...
        public void UpdateSize(int depth)
        {
            ...
            blockImage.color = CodeUtil.ChangeValueColor(Colors.ScaleColor, depth);
        }
