...
namespace Programmer
{
	public class VectorValue : IValue
	{
		...
		public VectorValue(IValue value1, IValue value2, IValue value3)
		{
			this.value1 = value1;
			this.value2 = value2;
			this.value3 = value3;
		...
		float IsNum(object n)
		{
			if (n is float || n is int) return (float)n;
			if (n is BigInteger) return (float) n;
			return 0;
		}
